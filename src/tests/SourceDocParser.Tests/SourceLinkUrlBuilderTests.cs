...
/// <summary>Pins <see cref="SourceLinkUrlBuilder"/> wildcard URL construction so SourceLink map resolution can stay focused on match ordering.</summary>
public class SourceLinkUrlBuilderTests
{
    /// <summary>Mixed platform separators in the local suffix are normalised to forward slashes.</summary>
    ...
    /// <summary>An empty wildcard suffix returns the original URL prefix unchanged.</summary>
    /// <returns>A task representing the test execution.</returns>
    [Test]
