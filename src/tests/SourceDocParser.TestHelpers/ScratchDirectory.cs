...
/// dispose.
/// </summary>
[System.Diagnostics.DebuggerDisplay("ScratchDirectory: {Path}")]
[ExcludeFromCodeCoverage(Justification = "Test-only class.")]
public sealed class ScratchDirectory : IDisposable
{
    /// <summary>Initializes a new instance of the <see cref="ScratchDirectory"/> class under the OS temp folder with a unique GUID-suffixed name.</summary>
