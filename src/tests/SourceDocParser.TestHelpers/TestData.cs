...
{
    /// <summary>Creates a minimal <see cref="ApiObjectType"/> in a deterministic shape using the default class kind and assembly name.</summary>
    ...
    /// <summary>Creates a minimal <see cref="ApiObjectType"/> in a deterministic shape using the default class kind and supplied assembly name.</summary>
    /// <param name="uid">Unique identifier (also drives FullName when not supplied).</param>
    ...
    /// <summary>Creates a minimal <see cref="ApiObjectType"/> in a deterministic shape using the supplied kind and default assembly name.</summary>
    /// <param name="uid">Unique identifier (also drives FullName when not supplied).</param>
    ...
    /// <summary>Creates a minimal <see cref="ApiObjectType"/> in a deterministic shape using the supplied kind and assembly name.</summary>
    /// <param name="uid">Unique identifier (also drives FullName when not supplied).</param>
    /// <param name="kind">Object kind (class / struct / interface / record / record struct).</param>
    /// <param name="assemblyName">Declaring assembly name.</param>
    /// <returns>The constructed object type.</returns>
    ...
    /// <summary>Creates a minimal <see cref="ApiObjectType"/> in a deterministic shape -- defaults to a class with no members.</summary>
    /// <param name="uid">Unique identifier (also drives FullName when not supplied).</param>
    /// <param name="kind">Object kind (class / struct / interface / record / record struct).</param>
    /// <param name="assemblyName">Declaring assembly name.</param>
    ...
    /// <summary>Creates a minimal <see cref="ApiEnumType"/> in a deterministic shape using the default assembly name.</summary>
    ...
    /// <summary>Creates a minimal <see cref="ApiEnumType"/> in a deterministic shape.</summary>
    /// <param name="uid">Unique identifier.</param>
    /// <param name="assemblyName">Declaring assembly name.</param>
    /// <returns>The constructed enum type with no values.</returns>
    ...
    /// <summary>Creates a minimal <see cref="ApiDelegateType"/> in a deterministic shape using the default assembly name.</summary>
    /// <param name="uid">Unique identifier.</param>
    ...
    /// <summary>Creates a minimal <see cref="ApiDelegateType"/> in a deterministic shape.</summary>
    /// <param name="uid">Unique identifier.</param>
    /// <param name="assemblyName">Declaring assembly name.</param>
    /// <returns>The constructed delegate type with a void Invoke signature.</returns>
    ...
    /// <summary>Creates an <see cref="ApiCatalog"/> for a TFM containing the supplied types.</summary>
    ...
    /// <summary>Creates a minimal class-shaped <see cref="ApiObjectType"/> using the default assembly name.</summary>
    /// <param name="uid">Unique identifier.</param>
    ...
    /// <summary>Creates a minimal class-shaped <see cref="ApiObjectType"/> using the supplied assembly name.</summary>
    /// <param name="uid">Unique identifier.</param>
    /// <param name="assemblyName">Declaring assembly name.</param>
    /// <returns>The constructed type.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
