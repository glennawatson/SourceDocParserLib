...
/// <summary>Pins slash normalization helpers used by archive and filesystem paths.</summary>
public class PathSeparatorHelpersTests
{
    ...
    {
        var expected = string.Join(Path.DirectorySeparatorChar.ToString(CultureInfo.InvariantCulture), "foo", "bar", "baz");
