...
/// <summary>Pins <see cref="DisabledPackageSourcesReader"/> against the with-creds fixture and inline canned XML for the off / non-true branches.</summary>
public class DisabledPackageSourcesReaderTests
{
    /// <summary>The fixture marks <c>legacy-feed</c> as disabled -- the reader returns it in the result set.</summary>
    ...
    /// <summary>Entries whose <c>value</c> isn't the literal <c>true</c> don't get reported -- disabled is opt-in only.</summary>
    /// <returns>A task representing the test execution.</returns>
    [Test]
