...
/// </summary>
[System.Diagnostics.DebuggerDisplay("ReferenceResolutionBenchmarks: {_locatorInputs}")]
...
public class ReferenceResolutionBenchmarks
{
    ...
    /// <summary>Framework reference resolved through the Windows SDK package map.</summary>
    private const string WinUiAssemblyName = "Microsoft.WinUI";

    /// <summary>Package reference that bypasses synthetic framework resolution.</summary>
    private const string ReactiveAssemblyName = "System.Reactive";
    ...
    /// <summary>Live snapshot used by the locator benchmarks. Captured once at global setup; the tested method never mutates it.</summary>
    ...
    public void GlobalSetup()
    {
        ...
        _ = Directory.CreateDirectory(_packsScratchRoot);
    ...
    /// <summary>Hot path: a known-platform exact name match. Called per transitive reference during compilation -- has to be cheap.</summary>
    /// <returns>Filter result.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Benchmark(Baseline = true)]
    public bool FilterExactMatch() => UnresolvableReferenceFilter.IsKnownUnresolvableName(WinUiAssemblyName);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Benchmark]
    public bool FilterNoMatch() => UnresolvableReferenceFilter.IsKnownUnresolvableName(ReactiveAssemblyName);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Benchmark]
    public string? PackageMapHit() => KnownFrameworkPackageMap.TryGetPackageId(WinUiAssemblyName);

    /// <summary>Synthetic-ref map miss for a real NuGet package.</summary>
    /// <returns>Mapped package id, or null.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Benchmark]
    public string? PackageMapMiss() => KnownFrameworkPackageMap.TryGetPackageId(ReactiveAssemblyName);
