...
/// </summary>
/// <param name="FolderName">Output folder for matching assemblies.</param>
/// <param name="AssemblyPrefix">Assembly-name prefix matched by this rule.</param>
/// <remarks>
...
/// </remarks>
[System.Diagnostics.DebuggerDisplay("PackageRoutingRule: {ToString(),nq}")]
