...
/// <summary>Per-walk cache of namespace display names keyed by <see cref="INamespaceSymbol"/>.</summary>
/// <remarks>
...
internal sealed class NamespaceDisplayNameCache
{
    ...
    /// <summary>Gets the cached display name for <paramref name="ns"/>, formatting and caching it on a miss.</summary>
    /// <param name="ns">Namespace symbol to render.</param>
    /// <returns>The formatted display name.</returns>
    internal string GetOrAdd(INamespaceSymbol ns)
    {
