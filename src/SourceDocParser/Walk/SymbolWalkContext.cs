...
/// <param name="NamespaceDisplayNames">Cache of formatted namespace names — populated lazily as the walker encounters each namespace; eliminates the per-type <c>ContainingNamespace.ToDisplayString()</c> repeat.</param>
