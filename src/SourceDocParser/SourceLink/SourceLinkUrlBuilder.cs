...
/// <summary>Shared builders for SourceLink-derived URLs.</summary>
internal static class SourceLinkUrlBuilder
{
    /// <summary>Appends the wildcard suffix to a URL prefix while normalising path separators.</summary>
    ...
    internal static string BuildWildcardUrl(string urlPrefix, string localPath, int suffixStart)
    {
