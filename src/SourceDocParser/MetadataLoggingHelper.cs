...
/// <summary>Helper methods for Metadata Extractor logging.</summary>
internal static partial class MetadataLoggingHelper
{
    ...
    internal static partial void LogEmitting(ILogger logger, int typeCount, string outputRoot, string emitterType);
    ...
    internal static partial void LogEmitComplete(ILogger logger, int typeCount, int pageCount, int sourceLinkCount, int loadFailures);
    ...
    internal static partial void LogDirectExtractComplete(ILogger logger, int typeCount, int sourceLinkCount, int loadFailures);
}
