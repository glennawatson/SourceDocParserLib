...
/// <summary>Disposable rental over a pooled <see cref="StringBuilder"/>. Use inside a <c>using</c> declaration so the builder returns to the pool on scope exit.</summary>
internal readonly struct PageBuilderRental : IEquatable<PageBuilderRental>, IDisposable
{
    ...
    internal PageBuilderRental(StringBuilder builder) => Builder = builder;
