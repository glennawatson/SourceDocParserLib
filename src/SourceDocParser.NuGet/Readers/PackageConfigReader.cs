...
internal static class PackageConfigReader
{
    ...
    /// <summary>Reads <c>nuget-packages.json</c> at <paramref name="path"/> and materialises a <see cref="PackageConfig"/>.</summary>
    ...
    internal static PackageConfig Read(string path)
    {
    ...
    /// <summary>Reads <c>additionalPackages</c> as an array of <see cref="AdditionalPackage"/>.</summary>
    /// <param name="root">Root JSON object.</param>
    ...
    /// <summary>Reads <c>referencePackages</c> as an array of <see cref="ReferencePackage"/>.</summary>
    /// <param name="root">Root JSON object.</param>
    ...
    /// <summary>Reads a string-to-string dictionary under <paramref name="propertyName"/>.</summary>
    /// <param name="root">Root JSON object.</param>
    /// <param name="propertyName">UTF-8 encoded property name to read.</param>
    ...
    /// <summary>Returns the string value of a required property, throwing when it is missing or not a string.</summary>
    ...
    /// <summary>Returns the string value of an optional property, or null if the property is absent or not a string.</summary>
    /// <param name="element">Object containing the property.</param>
    /// <param name="propertyName">UTF-8 encoded property name to read.</param>
    ...
    /// <summary>Gets a human-readable display name for a UTF-8 property name.</summary>
